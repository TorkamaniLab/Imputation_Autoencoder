...
#
#reference: https://raw.githubusercontent.com/optuna/optuna-examples/main/samplers/simulated_annealing_sampler.py
#Modified by Raquel Dias, https://github.com/raqueldias/
#
...
class SimulatedAnnealingSampler(BaseSampler):
    ...
    def _sample_neighbor_params(self, search_space):
        ...
        for param_name, param_distribution in search_space.items():
            ...
            if isinstance(param_distribution, distributions.UniformDistribution) or isinstance(param_distribution, distributions.LogUniformDistribution):
                width = (
                ...
                if isinstance(param_distribution, distributions.UniformDistribution):
                    ...
                    params[param_name] = np.exp(self._rng.uniform(np.log(neighbor_low),np.log(neighbor_high)))           
...
def objective(trial):
    ...
    y = trial.suggest_categorical("y", [-1, 1])
    z = trial.suggest_float("z", 0.0001, 1, log=True)
    return x ** 2 + y + z
